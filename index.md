  ...
  <section class="layout-chamada">
    <div class="container">
      <div class="chamada">
        ...
        <p class="chamada_subtitulo">Software de gestão simples e prático para pequenos negócios</p>
    ...
    <div class="container">
      ...
      <div class="depoimento">
        <blockquote>
          ...
          Depois que comecei a usar o MyPilas, me sinto muito organizado e confiante no futuro.
        </blockquote>
        
        <div class="depoimento__autor">
          <img class="depoimento__autor  depoimento--image" src="imagens/joao-da-silva.jpg" width="180px" height="180px" alt="João da Silva ">
          <p class="depoimento__autor  depoimento-autor--nome">João da Silva</p>
        </div>
      </div>
